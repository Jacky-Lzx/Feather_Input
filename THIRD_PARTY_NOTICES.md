...
- [luna-pinyin](https://github.com/rime/rime-luna-pinyin), [double-pinyin](https://github.com/rime/rime-double-pinyin), [stroke](https://github.com/rime/rime-stroke), [essay](https://github.com/rime/rime-essay), [prelude](https://github.com/rime/rime-prelude), and [rime-easy-en](https://github.com/BlindingDark/rime-easy-en): upstream licenses and pinned revisions are collected by `scripts/prepare-data.sh`. Their licensing is separate from librime, including LGPL/GPL data packages. Preserve source, attribution, and applicable redistribution obligations when publishing.
